...
router.post("/products", async (req, res): Promise<void> => {
  const { title, slug, brandId, categoryId, price, shortDescription, longDescription, featuredImage, galleryImages, published, featured, metaTitle, metaDescription, metaKeywords } = req.body;
  ...
  const [product] = await db.insert(productsTable).values({ title, slug: finalSlug, brandId, categoryId, price: String(price), shortDescription, longDescription, featuredImage, galleryImages: galleryImages ?? null, published: !!published, featured: !!featured, metaTitle, metaDescription, metaKeywords }).returning();
...
router.patch("/products/:id", async (req, res): Promise<void> => {
  ...
  const fields = ["title", "slug", "price", "shortDescription", "longDescription", "featuredImage", "galleryImages", "published", "featured", "hidePrice", "metaTitle", "metaDescription", "metaKeywords", "brandId", "categoryId", "tags", "salePrice", "costPrice", "stockQty", "sku", "barcode"];
