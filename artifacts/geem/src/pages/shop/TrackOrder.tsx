...
interface WebOrder { id: number; orderNumber: string; status: string; paymentStatus: string; customerName: string; customerCity: string; total: number; courierCn: string | null; courierName: string | null; courierTrackingUrl: string | null; courierProvider?: string | null; courierId?: number | null; createdAt: string; items: Array<{ description: string; qty: number; price: number; amount: number }>; }
              ...
              <Card className="border-blue-200">
                <CardContent className="pt-5 space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">
                    View the latest courier scan, delivery details, signature, and timestamps.
                  </p>
                  <Button type="button" variant="outline" onClick={() => setTrackingOpen(true)} className="text-blue-700 border-blue-200">
                    <Truck className="h-4 w-4 mr-2" /> View live status
                  </Button>
                </CardContent>
              </Card>
            )}
