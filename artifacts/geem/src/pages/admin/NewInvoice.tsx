...
function LineRow({ line, results, isActive, onActivate, onUpdate, onRemove, onSelect, onConfirmNew, canDelete, symbol, rate }: RowProps) {
  ...
  return (
    <div ref={wrapRef} className="relative">
      ...
      {/* Search dropdown */}
      {line.searchOpen && isActive && (
        <div className="absolute left-5 right-6 z-50 bg-white border rounded-lg shadow-xl overflow-hidden"
  ...
  return (
    <div className="max-w-3xl mx-auto pb-12">
      ...
      <div className="border rounded-xl bg-white shadow-sm overflow-visible">
        ...
        <div className="px-6 py-5 border-b">
          <div className="flex items-start">
            {/* Left spacer with green dot (Wave decorative element) */}
      ...
      <div className="flex justify-end gap-3 pt-4">
        <Button variant="outline" onClick={() => navigate(editMode ? `/invoices/${editId}` : "/invoices")}>Cancel</Button>
        {!editMode && (
          <Button variant="outline" onClick={() => handleSave("draft")} disabled={isBusy}>
            Save as Draft
          </Button>
        )}
        <Button onClick={() => handleSave(editMode ? "unpaid" : "unpaid")} disabled={isBusy}>
