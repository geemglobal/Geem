...
export const getUpdateInventoryShipmentUrl = (id: number,) => {




  return `/api/inventory/${id}/shipment`
}

/**
 * @summary Add or update the courier CN for an inventory item's sales shipment
 */
export const updateInventoryShipment = async (id: number,
    inventoryShipmentUpdate: InventoryShipmentUpdate, options?: RequestInit): Promise<InventoryItem> => {

  return customFetch<InventoryItem>(getUpdateInventoryShipmentUrl(id),
  {
    ...options,
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(inventoryShipmentUpdate)
  }
);}
...
export const getUpdateInventoryShipmentMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateInventoryShipment>>, TError,{id: number;data: BodyType<InventoryShipmentUpdate>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateInventoryShipment>>, TError,{id: number;data: BodyType<InventoryShipmentUpdate>}, TContext> => {

const mutationKey = ['updateInventoryShipment'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateInventoryShipment>>, {id: number;data: BodyType<InventoryShipmentUpdate>}> = (props) => {
          const {id,data} = props ?? {};

          return  updateInventoryShipment(id,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateInventoryShipmentMutationResult = NonNullable<Awaited<ReturnType<typeof updateInventoryShipment>>>
    export type UpdateInventoryShipmentMutationBody = BodyType<InventoryShipmentUpdate>
    export type UpdateInventoryShipmentMutationError = ErrorType<void>

    /**
 * @summary Add or update the courier CN for an inventory item's sales shipment
 */
export const useUpdateInventoryShipment = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateInventoryShipment>>, TError,{id: number;data: BodyType<InventoryShipmentUpdate>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof updateInventoryShipment>>,
        TError,
        {id: number;data: BodyType<InventoryShipmentUpdate>},
        TContext
      > => {
      return useMutation(getUpdateInventoryShipmentMutationOptions(options));
    }
...
export const updateModel = async (id: number,
  ...
  return customFetch<DeviceModel>(getUpdateModelUrl(id),
  {
    ...
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(deviceModelUpdate)
  }
);}
...
export const createPosDraft = async (posDraftInput: PosDraftInput, options?: RequestInit): Promise<PosDraft> => {
  ...
  return customFetch<PosDraft>(getCreatePosDraftUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(posDraftInput)
  }
);}
...
export const createImportOrder = async (importOrderInput: ImportOrderInput, options?: RequestInit): Promise<ImportOrder> => {
  ...
  return customFetch<ImportOrder>(getCreateImportOrderUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(importOrderInput)
  }
);}
...
export const updateImportOrder = async (id: number,
  ...
  return customFetch<ImportOrder>(getUpdateImportOrderUrl(id),
  {
    ...
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(importOrderUpdate)
  }
);}
...
export const createWebOrder = async (webOrderInput: WebOrderInput, options?: RequestInit): Promise<WebOrder> => {
  ...
  return customFetch<WebOrder>(getCreateWebOrderUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(webOrderInput)
  }
);}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetWebOrderQueryKey(id);
   ...
   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getWebOrder>>, TError, TData> & { queryKey: QueryKey }
}
...
export const updateWebOrder = async (id: number,
  ...
  return customFetch<WebOrder>(getUpdateWebOrderUrl(id),
  {
    ...
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(webOrderUpdate)
  }
);}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetServiceTicketQueryKey(id);
   ...
   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getServiceTicket>>, TError, TData> & { queryKey: QueryKey }
}
...
export const updateServiceTicket = async (id: number,
  ...
  return customFetch<ServiceTicket>(getUpdateServiceTicketUrl(id),
  {
    ...
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(serviceTicketUpdate)
  }
);}
