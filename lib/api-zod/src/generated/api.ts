...
export const ListInventoryResponse = zod.object({
  ...
  "shipmentStatus": zod.string().nullish(),
  "shipmentDestination": zod.string().nullish(),
  "shipmentSlipLink": zod.string().nullish(),
  "shipmentCreatedAt": zod.string().nullish()
})),
  "total": zod.number(),
  "page": zod.number(),
  "limit": zod.number()
 ...
 */
export const UpdateInventoryShipmentParams = zod.object({
  "id": zod.coerce.number()
})

export const UpdateInventoryShipmentBody = zod.object({
  "courierId": zod.number(),
  "cn": zod.string(),
  "status": zod.string().optional()
})

export const UpdateInventoryShipmentResponse = zod.object({
  "id": zod.number(),
  "imei": zod.string(),
  "deviceId": zod.string().nullish(),
  "iccid": zod.string().nullish(),
...
export const DeleteCourierResponse = zod.void()
...
export const CreatePosDraftResponse = zod.object({
  "id": zod.number(),
  "customerId": zod.number().nullish(),
  "customerName": zod.string(),
  "itemsCount": zod.number(),
...
export const DeletePosDraftResponse = zod.void()
...
export const CreateWebOrderResponse = zod.object({
  "id": zod.number(),
  "orderNumber": zod.string(),
  "status": zod.enum(['new', 'confirmed', 'processing', 'shipped', 'delivered', 'cancelled']),
  "paymentStatus": zod.enum(['pending', 'verified', 'rejected', 'cod']),
