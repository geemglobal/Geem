...
The GitHub webhook may retry after a dirty-tree pull failure, so verify the final commit and deploy log after stashing before starting another manual deploy.